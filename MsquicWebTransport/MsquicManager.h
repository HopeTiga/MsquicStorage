...
namespace hope {
	...
	namespace quic {
		...
		public:
			...
			MsquicManager(size_t channelIndex, boost::asio::io_context& ioContext, MsquicWebTransportServer * msquicWebTransportServer);
		...
		private:
			...
			hope::utils::MsquicHashMap<std::string, MsquicWebTransportSocket*> msquicCloudServerSocketMap;
